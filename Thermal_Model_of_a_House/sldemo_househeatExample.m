...
% file and re-load the model workspace. To view the model workspace, from
% the Simulink Editor, on the *Modeling* tab, click *Model Explorer*.
...
% within 5 &ordm;C of the |Set Point|. The time axis is in seconds.
evalc('sim(mdl)');
open_system([mdl '/PlotResults']),
%%
%
% According to this model, heating the house for two days would cost about
% $30. Try varying the parameters and observe the system response.
%%
close_system(mdl);
...
% parameters such as the following to
% <matlab:cd(setupExample('simulink_general/sldemo_househeatExample'));edit('sldemo_househeat_data.m')
